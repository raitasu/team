export const TranslationKeys = {
  ...
  ZIPCode:
    'domains:employee.titles.profile_tabs.personal_information.contacts.zip_code',
  building:
    'domains:employee.titles.profile_tabs.personal_information.contacts.building',
  unit: 'domains:employee.titles.profile_tabs.personal_information.contacts.unit',
  apartment:
    'domains:employee.titles.profile_tabs.personal_information.contacts.apartment'
} as const;
