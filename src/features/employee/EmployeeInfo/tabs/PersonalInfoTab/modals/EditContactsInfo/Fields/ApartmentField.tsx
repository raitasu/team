...
export const ApartmentField = () => {
  ...
  return (
    <FormControl
      label={t(TranslationKeys.apartment)}
      errorMessage={
        errors.apartment ? t(`general_errors:invalid_number`) : undefined
      }
    >
      <Input
        {...register('apartment')}
        placeholder={t(
          'domains:employee.placeholders.profile_tabs.contacts.enter_apartment'
        )}
      />
    </FormControl>
  );
